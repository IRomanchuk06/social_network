...
{
    std::cout << "======================================" << std::endl;
    std::cout << "           VanoNetwork feed           " << std::endl;
    std::cout << "======================================" << std::endl;
    std::cout << std::endl;
...
void UserInterface::DisplayStartMenu() {
    std::cout << "======================================" << std::endl;
    std::cout << "        Welcome to VanoNetwork!       " << std::endl;
    std::cout << "======================================" << std::endl;
...
void UserInterface::DisplayRegistrationMenu() {
    std::cout << "======================================" << std::endl;
    std::cout << "       Create an Account on          " << std::endl;
    std::cout << "            VanoNetwork              " << std::endl;
    std::cout << "======================================" << std::endl;
...
bool UserInterface::DisplayLoginMenu() {
    std::cout << "======================================" << std::endl;
    std::cout << "          Login to VanoNetwork        " << std::endl;
    std::cout << "======================================" << std::endl;
...
void UserInterface::DisplayLogout() {
    std::cout << "======================================" << std::endl;
    std::cout << "          Logout from VanoNetwork     " << std::endl;
    std::cout << "======================================" << std::endl;
